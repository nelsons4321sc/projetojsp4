...
@MultipartConfig
@WebServlet(urlPatterns = {"/ControleUsuario"})
public class ServletUsuarioController extends ServleGenericUtil {
	...
	// para deletar e consultar
		...
		if(acao != null && !acao.isEmpty() && acao.equalsIgnoreCase("deletar")) {
			...
			request.setAttribute("msg", "Cadastro de Cliente");
			request.setAttribute("modelLogins", modelLogins);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(daoUsuarioRepository.validarNome(modelLogin.getNome()) && modelLogin.getId() == null) {
			msg = "Já existe um nome cadastrado, por favor, informe outro nome.";
